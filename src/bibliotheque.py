...
#-------------Livre------------
    ...
    def charger_livres(self, chemin="data/livres.json"):
    ...
    def sauvegarder_livres(self, chemin="data/livres.json"):
        data = {}
        for isbn, info in self.livres.items():
            livre = info["livre"]
            data[isbn] = {
...
#---------------Membre--------------
    ...
    def sauvegarder_membres(self, chemin="data/membres.json"):
        data = {}
    ...
    def charger_membres(self, chemin="data/membres.json"):
        if not os.path.exists(chemin):
           raise FileNotFoundError(f"Fichier '{chemin}' introuvable.")
        try:
            with open(chemin, "r") as f:
