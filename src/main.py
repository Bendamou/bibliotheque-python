"""
La totalité de la logique backend (traitement des données, gestion des fichiers, classes et exceptions) a été développée manuellement par moi-même. 
J'ai uniquement utilisé ChatGPT comme assistant pour la création de l’interface graphique avec Tkinter, notamment pour la structure des frames et les composants visuels.
"""
...
class App(tk.Tk):
    def __init__(self,bib):
        ...
        self.title("Application de Bibliothèque")
        ...
        # Barre de navigation
        self.menu_bar = tk.Frame(self.container, bg="#2c3e50", height=50)
        ...
        for idx, (text, frame_name) in enumerate(buttons):
            btn = tk.Button(self.menu_bar, text=text, bg="#34495e", fg="white",
